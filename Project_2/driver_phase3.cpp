...
int main() {
    ...
    read(list);
    list.print();
    std::cout << "Size after reading: " << list.getSize() << "\n";

    std::cout << "\nTesting front(): " << list.front() << "\n";
    ...
    list.print();
    std::cout << "Size after insertAfter: " << list.getSize() << "\n";

    std::cout << "\nTesting eraseAfter():\n";
    it = list.find(26);
    it = list.eraseAfter(it);
    list.print();
    std::cout << "Size after eraseAfter: " << list.getSize() << "\n";

    std::cout << "\nTesting pop_front():\n";
    list.pop_front();
    list.print();
    std::cout << "Size after pop_front: " << list.getSize() << "\n";
    ...
    std::cout << "Original:\n"; list.print();
    std::cout << "Copy:\n"; copiedList.print();
    std::cout << "Copied list size: " << copiedList.getSize() << "\n";

    std::cout << "\nTesting empty():\n";
    List emptyList;
    std::cout << "Empty: " << emptyList.empty() << "\n";
    emptyList.push_back(99);
    std::cout << "Front after push_back(99): " << emptyList.front() << "\n";
    std::cout << "Size of emptyList now: " << emptyList.getSize() << "\n";

    std::cout << "\nTesting clear():\n";
    list.clear();
    std::cout << "List cleared. Size = " << list.getSize() << "\n";
    list.print();
